        ...
        <div class="footer-content">
          <a href="${isSubPage ? '../index.html' : 'index.html'}" class="brand-link">
            <div class="brand-section">
              <img src="${imagePrefix}site_logo.png" alt="zerocalculator Logo" class="brand-logo">
          ...
          <div class="footer-links">
              ...
              <a href="${isSubPage ? '../privacy/' : 'privacy/'}" class="footer-link">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="${isSubPage ? '../terms/' : 'terms/'}" class="footer-link">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/>
                </svg>
                <span>Terms of Service</span>
              </a>
              <a href="${isSubPage ? '../contact-us/' : 'contact-us/'}" class="footer-link">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M20,8L12,13L4,8V6L12,11L20,6M20,4H4C2.89,4 2,4.89 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6C22,4.89 21.1,4 20,4Z"/>
                </svg>
                <span>Contact Us</span>
              </a>
              <a href="https://github.com/rajeevsengar/Zero_Calculator" target="_blank" rel="noopener noreferrer" class="footer-link">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
