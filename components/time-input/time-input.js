class TimeInput extends HTMLElement {
    ...
    render() {
        ...
        this.shadowRoot.innerHTML = `
            <link rel="stylesheet" href="${window.getCSSPaths ? window.getCSSPaths().components.timeInput : '../../components/time-input/time-input.css'}">
     ...
     * @param {string} theme - Theme name (default, green, black)
     */
    updateTheme(theme) {
